...
contract FundMeTest is Test {
    ...
    function testWithdrawWithASingleFunder() public funded {
        vm.prank(USER);
        // Arrange
        uint256 startingOwnerBalance = fundMe.getOwner().balance; // .balance is a built-in Solidity property that returns the current amount of Ether (in wei) held by an address. Any address, whether it belongs to an externally owned account (EOA) or a contract, has this property.
